...
namespace _root.Script.Title
{
    public class SignUi : MonoBehaviour
    {
        ...
        {
            var post = new SignInRequest { id = idField.text, password = passwordField.text };
            Init();
            return post;
        }
        ...
        {
            var post = new SignUpRequest { id = idField.text, password = passwordField.text, name = nameField.text };
            Init();
