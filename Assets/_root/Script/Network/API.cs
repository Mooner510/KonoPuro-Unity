...
public static class API
{
	...
	public static Networking.Put<Void> PasswordChange(PasswordChangeRequest req) => new("/api/auth/password", req);

	public static Networking.Put<Void> IdChange(IdChangeRequest req) => new("/api/auth/id", req);
	...
	public static Networking.Get<GatchaResponses> GatchaList() => new("/api/gatcha/list");
	...
	public static Networking.Get<CardDataResponses> GetCardAll() => new("/api/card/all");

	public static Networking.Post<Void> Match() => new("/api/game/match", null);

	public static Networking.Delete<Void> MatchCancel() => new("/api/game/match-cancel");

	public static Networking.Get<PlayerCardResponses> GetInventoryCardAll() => new("/api/inventory");
